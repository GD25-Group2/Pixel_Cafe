...
require('src.states.game.GameWinConditionDecide')
require('src.states.game.Challenge')
...
require('src.states.GUI.GameWinBackground')
require('src.states.GUI.GameWinCard')
require('src.states.GUI.ChallengeCard')